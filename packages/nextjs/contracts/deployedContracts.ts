...
const deployedContracts = {
  5003: {
    BasketFactory: {
      address: "0xB73bf6E7710066f08E873C0e953Bc55fcfB216EA",
      abi: [
        {
          inputs: [
            {
      ...
      deployedOnBlock: 33435361,
    },
    BasketOracle: {
      address: "0x97A23462682CF6c3cd92b5F9aA822a81205BE4FD",
      abi: [
        {
          inputs: [
            {
      ...
      deployedOnBlock: 33435242,
    },
    BasketRegistry: {
      address: "0x209B9753Cd9c196507EA56985073f9258763671A",
      abi: [
        {
          inputs: [],
          stateMutability: "nonpayable",
      ...
      deployedOnBlock: 33435237,
    },
    BasketVault: {
      address: "0x691A33e38e3eFBd1098ba5c2094a0Cd8eB93A045",
      abi: [
        {
          inputs: [
            {
